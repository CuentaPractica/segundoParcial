...
<div id="borde"></div>
<div id="cuadro">
  <nav class="titulo"><h3>REGISTRAR PROVEEDOR</h3></nav>
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      <label for="empresa">Empresa</label>
        <input type="text" name="empresa" value="{{old('empresa')}}" class="form-control" id="empresa" placeholder="empresa" required>
        @error('empresa')
             <span class="text-danger">{{ $message}}</span>
        @enderror
    </div>
    ...
    <div class="col-md-4 mb-3">
      <label for="direccion">Direccion</label>
        <input type="text" name="direccion" value="{{old('direccion')}}" class="form-control" id="direccion" placeholder="direccion" required>
        @error('direccion')
             <span class="text-danger">{{ $message}}</span>
        @enderror
    </div>
